...
describe("PATCH /swap-credentials", () => {
	...
	test("400 - Campo 'phone' é null", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'phone' é um objeto", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'phone' é um array", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'phone' é número", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'cpf' é null", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'cpf' é enviado vazio", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'cpf' é um objeto", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'cpf' é um array", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'cpf' é um número", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'cpf' inválido", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'date' é null", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'date' é um objeto", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'date' é um array", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'nationality' é null", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'nationality' é enviado vazio", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'nationality' é um objeto", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'nationality' é um array", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'nationality' é um número", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'sex' é null", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'sex' é enviado vazio", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'sex' é um objeto", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'sex' é um array", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
	...
	test("400 - Campo 'sex' é um número", async () => {
		const res = await api({
			method: "PATCH",
			url: "/swap-credentials",
			headers: {
